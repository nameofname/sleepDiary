...
require(__DIR__ . '/rest_modifiers/Rest_Modifiers.php');
 ...
 * -or-
 * /rest/model/123/sub-model
 * TODO !!! REST Controller is now behind authentication! Should I kill any requests that are not from a logged in user?
 * TODO : Perhaps not because there might be a user for a 3rd party...
 */
class Rest extends Auth_Controller {
    ...
    // A flag indicating the filter name for get requests.
    ...
    public function __construct(){
        parent::__construct();
        // TODO: enable loading the user model to check that the user requesting the specified action has permissions.
...
//            }
    ...
    /**
     * Private function to validate requests against the user. I do not validate for GET requests, but I ALWAYS
